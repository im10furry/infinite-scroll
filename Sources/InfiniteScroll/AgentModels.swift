...
/// A deliberately small, content-free process observation. It is enough to
/// recognize a provider and connect it to a terminal cell without retaining a
/// command, terminal output, prompt, or environment variable.
